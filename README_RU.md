...
| Операционная система | Чистый образ | Обновлённая система | Голос/Видео | Результат |
|---|:---:|:---:|:---:|:---:|
| Debian 13.6 | ✅ | ✅ | ✅ | Успешно |
| Ubuntu 24.04 LTS | ✅ | ✅ | ✅ | Успешно |
| Ubuntu 26.04 LTS | ✅ | ✅ | ✅ | Успешно |

Рабочий installer-flow проверен на живом VPS. Подтверждена работа установки, TLS, healthcheck, федерации, создания пользователей и администраторов, сообщений, push-уведомлений, голосовых и видеозвонков, резервного копирования и восстановления.
